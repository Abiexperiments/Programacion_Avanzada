...
//*************************************************
	...
	//cargar los productos de un archivo 
	public static String[][] CargarProductos() {
	    ...
	    return producto;
	    //clase producto con getters y setter precio cantidad producto
	    //los elementos los regresa como un arreglo to string
	} 		
...
return enc;
//lista generica para todas las clases
}
...
System.out.println("Desbordamiento de Memeoria de ventas");	
	...
	do 
	{ 
 		//int posticket=ObtenerUltimaPosicion(Vticket);
		...
		if (!Tickettexto.trim().isEmpty())
		{
			...
			if (opcion == null) 
				...
				case "2":  Eliminar(Vticket,tamticket); break;
